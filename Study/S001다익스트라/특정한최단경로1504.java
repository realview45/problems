...
public class 특정한최단경로1504 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        dijk(1);
        int oneTov1 = dist[v1]; int oneTov2 = dist[v2];
        dijk(v1);
        int v1Tov2 = dist[v2];
        dijk(V);
        int v1ToV = dist[v1]; int v2ToV = dist[v2];

        int path1 = oneTov1 + v1Tov2 + v2ToV;
        int path2 = oneTov2 + v1Tov2 + v1ToV;
